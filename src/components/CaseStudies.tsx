...
export default function CaseStudies() {
  return (
    <div className="w-full bg-main text-text-primary">
      {/* Case 1: SMM & BRAND IDENTITY */}
      <section id="smm-brand" className="py-32 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col justify-center gap-8">
              <h3 className="text-4xl font-display font-medium">Magazine Collage Layout</h3>
      ...
      <section id="ecommerce" className="py-32 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
      ...
      <section id="vibe" className="py-32 px-8 bg-[#EAECEE] text-[#1A1D20] overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-sm font-mono tracking-widest text-[#8C9298] mb-8">CASE 04 // EIDOS-STUDIO.RU</h2>
            <h3 className="text-5xl font-display font-medium mb-8">Vibe-Coding & Fast Web</h3>
          ...
          <div className="relative h-[400px] perspective-1000">
            <motion.div
              ...
              className="absolute right-10 top-0 w-3/4 aspect-[16/10] bg-[#D8DBDE] rounded-xl shadow-2xl border border-white/50 flex items-center justify-center"
            >
              Laptop Mockup
            </motion.div>
            <motion.div
              whileHover={{ rotateX: 5, rotateY: 10 }}
              className="absolute right-0 bottom-0 w-1/3 aspect-[9/19] bg-[#1A1D20] rounded-3xl shadow-2xl border-4 border-[#484D53] flex items-center justify-center text-white text-xs"
            >
              Mobile
            </motion.div>
          </div>
      ...
      <section id="ai" className="py-32 px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-sm font-mono tracking-widest text-text-secondary mb-12">CASE 05 // K.A.I. INTELLIGENCE</h2>

          <div className="bg-surface rounded-xl border border-white/10 overflow-hidden shadow-2xl font-mono text-sm">
            {/* Terminal Header */}
            <div className="bg-black/50 px-4 py-3 border-b border-white/5 flex items-center justify-between">
            ...
            {/* Terminal Body */}
            <div className="p-6 h-[300px] flex flex-col gap-4 text-text-primary/90">
              <div className="flex gap-4">
                <span className="text-accent opacity-70">➜</span>
                <span className="text-text-secondary">~/kai-agent</span>
              ...
              <TypewriterText text="[SUCCESS] Agent ready. Awaiting input." delay={2500} className="text-accent" />
